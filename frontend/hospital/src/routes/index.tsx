	...
	return (
		<div className="container">
			<Switch>
				...
				<Route exact path="/summary" component={(props: any) => <RequireAuth {...props} Component={Summary} />} />
				<Route exact path="/history" component={(props: any) => <RequireAuth {...props} Component={History} />} />
				<Route
					exact
					path="/account/create"
